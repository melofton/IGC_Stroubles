...
#Old way to do method in "mutate" is below
...
B1_QA <- B1_WQ %>%
  mutate(Flag_Temp_degC = ifelse(Temp_degC < -5 | Temp_degC > 30, 1, 0),
         ...
         #Play around with flagging DO if 0 or something else
...
#Save the merged, quality-assured file
```{r}
write_csv(B1_QA, "B1_QA.csv", append = TRUE)
```